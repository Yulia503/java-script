...
// console.log(apartment.area);
// console.log(apartment.rooms);
// console.log(apartment.location.contry);
// console.log(apartment.location.city);
...
//   tomorrow: 33,
// };
// const keys = Object.keys(highTemperatures)
// const { yesterday, today, tomorrow } = highTemperatures;
// const meanTemperature = (yesterday + today + tomorrow )/ keys.length
